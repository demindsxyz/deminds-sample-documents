...
| packages/obsidian-sample-package.zip | Obsidian-style Markdown Package .zip | blob/raw file | Accepted if package size is within archive limit | Opens Markdown notes with related image assets when supported | small | ready | Copied from DEV fixture; about 2.6 MB with nested Markdown folders and image assets. |
