...
| Too-large file behavior | Boundary | manual/mock | Reject above auto-import limit and suggest local import | Local import can still be tried by user | boundary | deferred | Do not add large sample in v0.1. |
