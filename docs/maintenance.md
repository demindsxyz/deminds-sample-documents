...
- Keep docs aligned with current DeMinds shipped capability.
- If DeMinds app behavior changes, update this repository in the same release cycle.
- Do not turn this repository into a full documentation website.

When implementation and docs disagree, mark the mismatch instead of guessing.
